...
export const organizationKeys = {
  ...
  memberPermissions: (orgId: string, userId: string) =>
    [...organizationKeys.detail(orgId), "member-permissions", userId] as const,
...
export const PERMISSION_LABELS: Record<string, { label: string; group: string }> = {
  ...
  "organization.manage_members": { label: "Manage members", group: "Members" },
  ...
  "team.read": { label: "View teams", group: "Teams" },
  "team.create": { label: "Create teams", group: "Teams" },
  "team.update": { label: "Update teams", group: "Teams" },
  "team.delete": { label: "Delete teams", group: "Teams" },
  "team.manage_members": { label: "Manage team members", group: "Teams" },
  "user.read": { label: "View users", group: "Users" },
  "user.update": { label: "Update users", group: "Users" },
  ...
  "sprint.read": { label: "View sprints", group: "Sprints" },
  "sprint.create": { label: "Create sprints", group: "Sprints" },
  "sprint.update": { label: "Update sprints", group: "Sprints" },
  "sprint.delete": { label: "Delete sprints", group: "Sprints" },
