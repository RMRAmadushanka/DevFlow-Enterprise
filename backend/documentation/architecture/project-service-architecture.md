# Project Service Architecture — Phase 4

> Canonical path for Prompt 5E. Content mirrors [project-architecture.md](./project-architecture.md).
...
- [Events](../events/phase-4-project-events.md)
