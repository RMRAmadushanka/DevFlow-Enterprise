...
/**
 * Transactional outbox poller: reads PENDING rows, publishes EventEnvelope JSON to KafkaTopics.SPRINT_EVENTS,
...
public class OutboxPublisher {
    ...
    private static final String SOURCE = "sprint-service";
    ...
    private void publishOne(OutboxEvent event) {
        ...
        try {
            ...
            kafkaTemplate.send(KafkaTopics.SPRINT_EVENTS, event.getAggregateId(), json).get();
