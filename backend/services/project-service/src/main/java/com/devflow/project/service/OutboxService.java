 ...
 * Actual Kafka publish is performed asynchronously by {@link com.devflow.project.events.OutboxPublisher}.
 */
@Service
public class OutboxService {
    ...
    @Transactional
    public void enqueue(ProjectEventType eventType, String aggregateId, Map<String, Object> payload) {
