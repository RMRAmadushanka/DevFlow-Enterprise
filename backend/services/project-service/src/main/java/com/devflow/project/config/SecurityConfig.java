...
public class SecurityConfig {
    ...
    /**
     * When false (recommended for docker/prod), OpenAPI/Swagger require authentication.
     * Local default remains public for developer convenience ({@code OPENAPI_PUBLIC=true}).
     */
    @Value("${devflow.security.openapi-public:true}")
    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http, ObjectMapper objectMapper) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> {
                    ...
                    auth.requestMatchers(HttpMethod.GET, "/api/v1/project/health").permitAll();
                    if (openApiPublic) {
