...
/**
 * Transactional outbox poller: reads PENDING rows, publishes EventEnvelope JSON to KafkaTopics.TASK_EVENTS,
...
public class OutboxPublisher {
    ...
    private void publishOne(OutboxEvent event) {
        ...
        try {
            ...
            kafkaTemplate.send(KafkaTopics.TASK_EVENTS, event.getAggregateId(), json).get();
