...
import com.devflow.task.repository.OutboxEventRepository;
 ...
 * Actual Kafka publish is performed asynchronously by {@link com.devflow.task.events.OutboxPublisher}.
 */
@Service
public class OutboxService {
    ...
    @Transactional
    public void enqueue(TaskEventType eventType, String aggregateId, Map<String, Object> payload) {
